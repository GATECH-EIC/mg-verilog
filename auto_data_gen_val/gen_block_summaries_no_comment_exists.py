    ...
    with get_openai_callback() as cb:
        for code_part_id in range(code_part_start_id, total_code_parts):
            ...
            codedb.load_and_split_code(skip_small_doc=True, split_by_line=True, based_on_code_lines_only=True, 
                                        ...
                                        csv_comment_dir="/home/user_name/DAC_2024/ckpts/test_10_30_{}_complete/assets/verilog/code_and_comment_src/csv_src/csv_comment_src".format(code_part_id)
                                    )
            codedb.init_vectorstore()
            codedb.supplement_summary(block_summary_placeholding=False, use_global_summary_for_block_summary=False)
