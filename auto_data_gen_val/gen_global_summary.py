    ...
    with get_openai_callback() as cb:
        for code_part_id in range(code_part_start_id, total_code_parts):
            ...
            if detailed:
                ...
                codedb.supplement_summary(block_summary_placeholding=True,force_refresh_global_summary=True, global_summary_example_desc_key="detail_description")
                ...
                codedb.init_vectorstore(global_summary_chain_from_verilog_eval=True,
                                        global_summary_model=model,
                                        global_summary_example_cstr_json = "./preprocess_data/example_code_strings_simple_instructions.json",
                                        global_summary_example_code_description_file= "../verilog_eval/descriptions/VerilogDescription_Machine.jsonl"
                                        )
                codedb.supplement_summary(block_summary_placeholding=True,force_refresh_global_summary=True, global_summary_example_desc_key="simple_description")
                codedb.save_global_summary(
